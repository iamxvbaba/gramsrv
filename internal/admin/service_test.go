...
func (*fakeGiftsService) DeleteEverywhere(context.Context, int64, bool, bool, int) (domain.StarGiftDeletionResult, error) {
	return domain.StarGiftDeletionResult{}, nil
}
